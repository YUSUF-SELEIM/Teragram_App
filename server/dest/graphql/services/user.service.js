...
export const getAllUsers = async (_parent, args, contextValue) => {
...
export const getUserInfo = async (_parent, args, contextValue) => {
    console.log('Context:', contextValue);
    console.log('Context user:', contextValue.user);
    if (!contextValue.user) {
        throw new Error('Not authenticated');
...
// Register a new user
export const register = async (_parent, args) => {
...
export const updateUserInfo = async (_parent, args, contextValue) => {
